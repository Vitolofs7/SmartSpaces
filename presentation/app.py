"""
SmartSpaces REST API - Versión completa equivalente a labs expendedora
Equivalente a Lab A1 + Lab A2 de UT4 Flask
"""
...
# Crear servicios - Bootstrap: montar todas las piezas antes de que empiece
...
def create_meeting_room_route(
    ...
    Nota: equipment_list se pasa como parámetro JSON en el cuerpo.
