...
> ⚠️ Running `crear_bd.py` again after deletion will recreate the database with the initial seed data.
...
SmartSpaces
 ...
 ┣ 📜crear_bd.py                # Script to initialize and seed the SQLite database
 ┣ 📜smartspaces.db             # SQLite database file (auto-generated by crear_bd.py)
